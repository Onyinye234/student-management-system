...
public class StudentController {
    ...
    @PostMapping
    public ResponseEntity<CustomResponse> registerStudent( @RequestBody @Valid StudentRegistrationRequest studentRegistrationRequest){
        return ResponseEntity.ok(
                new CustomResponse("00", "Successful", studentService.enrollStudent(studentRegistrationRequest))
        );
